...
room = ["You can see the line of torches continuing further to the north", 2, 5, 0, None, item2]
room_list.append(room)
...
room = ["A huge troll is blocking the way forward. The only way forward is to fight him.", None, 7, None, 1, None]
room_list.append(room)

room = [" ", None, None, None, 6, item1]
room_list.append(room)

room = ["The troll smashes you in the head with his club and you are fucking dead.", None, None, None, None]
room_list.append(room)
...
while not done:
    ...
    # print(current_room)
    if current_room == 3 or current_room == 7:
        break
    ...
    while not done:
        ...
        if answer == "q":
            ...
            if inventory_list is None:
                ...
                continue
            print("You have a", inventory_list, "in your inventory." )
